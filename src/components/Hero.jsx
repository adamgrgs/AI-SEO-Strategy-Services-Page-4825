  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      >
        ...
        >
          I help brands move beyond traditional search and become discoverable across the emerging ecosystem of 
          <span className="text-blue-400 font-semibold"> large language models</span> and 
          <span className="text-purple-400 font-semibold"> intelligent agents</span>. 
          With 12+ years of experience in performance marketing and SEO — now fused with AI, analytics, and automation.
        </motion.p>
